    ...
    <>
      ...
      <View style={styles.menuCard}>
        ...
        <MenuItem
          ...
          value="Uzcard"
          onPress={() => Alert.alert("To'lov", "To'lov usullarini sozlash funksiyasi tez orada qo'shiladi")}
        />
        <View style={styles.menuDivider} />
        <MenuItem
        ...
        <MenuItem
          ...
          label="Til"
          value="O'zbekcha"
          onPress={() => Alert.alert("Til", "Tilni o'zgartirish funksiyasi tez orada qo'shiladi")}
        />
        <View style={styles.menuDivider} />
        <MenuItem
          icon="shield-checkmark-outline"
          label="Xavfsizlik"
          onPress={() => Alert.alert("Xavfsizlik", "Xavfsizlik sozlamalari tez orada qo'shiladi")}
        />
        <View style={styles.menuDivider} />
        <MenuItem
          icon="help-circle-outline"
          label="Yordam"
          onPress={() => Alert.alert("Yordam", "Yordam markazi tez orada qo'shiladi")}
        />
        <View style={styles.menuDivider} />
        <MenuItem
          icon="information-circle-outline"
          label="Ilova haqida"
          onPress={() => Alert.alert("Ilova haqida", "City market v1.0.0")}
        />
      </View>
