...
export default function AdminOrdersScreen() {
  ...
  const { data: couriers = [] } = useQuery<any[]>({
    ...
    queryFn: () => apiRequest("GET", "/api/couriers").then(res => res.json()),
  });
...
const getStyles = (isDarkMode: boolean) => {
  ...
  return StyleSheet.create({
    ...
    totalRow: { flexDirection: "row", justifyContent: "space-between", paddingTop: 12, borderTopWidth: 1, borderTopColor: Colors.divider, marginTop: 12 },
    totalLabel: { fontFamily: "Poppins_600SemiBold", fontSize: 13, color: Colors.text },
    totalValue: { fontFamily: "Poppins_700Bold", fontSize: 14, color: Colors.primary },
    ...
    courierListTitle: { fontFamily: "Poppins_600SemiBold", fontSize: 13, color: Colors.text, marginBottom: 8 },
    ...
    courierName: { fontFamily: "Poppins_500Medium", fontSize: 13, color: Colors.text },
