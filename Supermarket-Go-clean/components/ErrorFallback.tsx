  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={styles.content}>
        ...
        {retryCount > 0 && (
          <Text style={[styles.retryInfo, { color: theme.warning }]}>
            Urinishlar soni: {retryCount}/{maxRetries}
          </Text>
        )}
          ...
          {canRetry && !isRetrying && (
            ...
            >
              <Text style={[styles.buttonText, { color: theme.buttonText }]}>
                Qayta urinish {remainingRetries > 0 && `(${remainingRetries} qoldi)`}
              </Text>
            </Pressable>
          )}

          {isRetrying && (
            <View style={[styles.button, styles.retryingButton]}>
              <Text style={[styles.buttonText, { color: theme.buttonText }]}>
                Qayta urinish...
              </Text>
            </View>
