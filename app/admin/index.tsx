...
export default function AdminDashboard() {
  ...
  if (!user || user.role !== "admin") {
    return (
      <View style={[styles.container, { paddingTop: insets.top + 100, alignItems: "center" }]}>
        ...
        <Text style={{ fontFamily: "Poppins_700Bold", fontSize: 20, marginTop: 16, color: Colors.text }}>Ruxsat yo'q</Text>
        <Text style={{ fontFamily: "Poppins_400Regular", fontSize: 14, marginTop: 8, color: Colors.textSecondary, textAlign: "center" }}>
  ...
  const STATUS_CONFIG = {
    ...
    preparing: { label: "Tayyorlanmoqda", color: "#3B82F6", bg: "#EFF6FF", icon: "bag-handle" as const },
...
const getStyles = (isDarkMode: boolean) => {
  ...
  return StyleSheet.create({
    ...
    orderCustomer: {
      fontFamily: "Poppins_600SquiBold",
      fontSize: 14,
      color: Colors.text,
      flex: 1,
      minWidth: 0,
